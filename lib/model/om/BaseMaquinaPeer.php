...
abstract class BaseMaquinaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('MaqCodigo', 'MaqEstCodigo', 'MaqComCertificado', 'MaqNombre', 'MaqMarca', 'MaqModelo', 'MaqFechaAdquisicion', 'MaqFotoUrl', 'MaqTiempoInyeccion', 'MaqFechaRegistroSistema', 'MaqCodigoInventario', 'MaqUsuCrea', 'MaqUsuActualiza', 'MaqFechaActualizacion', 'MaqEliminado', 'MaqCausaEliminacion', 'MaqCausaActualizacion', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('maqCodigo', 'maqEstCodigo', 'maqComCertificado', 'maqNombre', 'maqMarca', 'maqModelo', 'maqFechaAdquisicion', 'maqFotoUrl', 'maqTiempoInyeccion', 'maqFechaRegistroSistema', 'maqCodigoInventario', 'maqUsuCrea', 'maqUsuActualiza', 'maqFechaActualizacion', 'maqEliminado', 'maqCausaEliminacion', 'maqCausaActualizacion', ),
		BasePeer::TYPE_COLNAME => array (self::MAQ_CODIGO, self::MAQ_EST_CODIGO, self::MAQ_COM_CERTIFICADO, self::MAQ_NOMBRE, self::MAQ_MARCA, self::MAQ_MODELO, self::MAQ_FECHA_ADQUISICION, self::MAQ_FOTO_URL, self::MAQ_TIEMPO_INYECCION, self::MAQ_FECHA_REGISTRO_SISTEMA, self::MAQ_CODIGO_INVENTARIO, self::MAQ_USU_CREA, self::MAQ_USU_ACTUALIZA, self::MAQ_FECHA_ACTUALIZACION, self::MAQ_ELIMINADO, self::MAQ_CAUSA_ELIMINACION, self::MAQ_CAUSA_ACTUALIZACION, ),
		BasePeer::TYPE_FIELDNAME => array ('maq_codigo', 'maq_est_codigo', 'maq_com_certificado', 'maq_nombre', 'maq_marca', 'maq_modelo', 'maq_fecha_adquisicion', 'maq_foto_url', 'maq_tiempo_inyeccion', 'maq_fecha_registro_sistema', 'maq_codigo_inventario', 'maq_usu_crea', 'maq_usu_actualiza', 'maq_fecha_actualizacion', 'maq_eliminado', 'maq_causa_eliminacion', 'maq_causa_actualizacion', ),
