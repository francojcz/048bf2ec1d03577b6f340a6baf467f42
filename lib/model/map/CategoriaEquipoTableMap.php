...
/**
 * This class defines the structure of the 'categoria_equipo' table.
 *
 *
 ...
 */
class CategoriaEquipoTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.CategoriaEquipoTableMap';
	...
	{
	  // attributes
		$this->setName('categoria_equipo');
		$this->setPhpName('CategoriaEquipo');
		$this->setClassname('CategoriaEquipo');
